...
- **Cards:** visão agrupada por empregado, com matrícula em destaque, selo de reincidência, filtros em pill e expander das pendências.
- **Calendário:** dois meses lado a lado no período operacional de 21 a 20, com dias fora da competência em cinza claro e legenda por responsável da pendência.
